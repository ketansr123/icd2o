...
#3) 
float1=float(input("What is your first float"))
float2=float(input("What is your second float?"))
float3=float(input("What is your third float"))
areaf=average_of_three_floats(float1, float2, float3)
print(f"The average of the three numbers is {areaf:.2f}")
